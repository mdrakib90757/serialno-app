...
class NextButtonService{
  ...
  Future<dynamic>nextButton({required String serviceCenterId, required String date})async{
    try{
      var response= await ApiClient().post("/serial-no/service-centers/$serviceCenterId/services/$date/next");
  ...
  Future<List<SerialModel>>getNextButton(String serviceCenterId, String date)async{
    try{
