...
class Servicecenter_Bookserial_service {
  Future<List<ServiceCenterModel>> ServiceCenter_bookserialService(
    String companyId,
  ) async {
    ...
    final String urlString =
        '${apiConfig.baseUrl}/companies/$companyId/service-centers?';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        List<ServiceCenterModel> serviceCenters = jsonList
            .map(
              (json) =>
                  ServiceCenterModel.fromJson(json as Map<String, dynamic>),
            )
            .toList();
