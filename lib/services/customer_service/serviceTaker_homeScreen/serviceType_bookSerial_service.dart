...
class serviceTypeserialbook_service{
  ...
  Future<List<serviceTypeModel>>fetchServiceType_serialbook( String companyId)async{
    ...
    final String urlString = '${apiConfig.baseUrl}/companies/$companyId/service-types';
