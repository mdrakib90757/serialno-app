  ...
  Future<List<MybookedModel>> getCommentCancelButton(String? date) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
          "Error fetching GetCommentCancelButtonService: ${response.statusCode} - ${response.body}",
        );
      ...
      print(
        "Exception during fetching GetCommentCancelButtonService serials:-- $e",
      );
      throw Exception(
        'Failed to load GetCommentCancelButtonService due to an exception',
      );
    }
  }
}
