...
class BookSerialButtonService {
  ...
  Future<bool> bookSerialButton({
    ...
    final url = Uri.parse(
      '${Api.baseUrl}/api/serial-no/service-centers/$serviceCenterId/services/book',
    );
    ...
    try {
      ...
      print(
        "BookSerialService body ${jsonEncode({"businessTypeId": businessTypeId, "serviceCenterId": serviceCenterId, "serviceTypeId": serviceTypeId, "serviceDate": serviceDate, "serviceTaker": serviceTaker, "contactNo": contactNo, "name": name, "organizationId": organizationId, "forSelf": forSelf})}",
      );
