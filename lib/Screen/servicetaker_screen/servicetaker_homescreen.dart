...
class _ServicetakerHomescreenState extends State<ServicetakerHomescreen> {
  ...
  Future<void> _loadBusinessTypes() async {
    try {
      ...
      if (mounted) { // <<< finally ব্লকেও mounted চেক করুন
        setState(() {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<GetBookSerialProvider>(context, listen: false)
                          ...
                          child: Consumer<GetBookSerialProvider>(
                              builder: (context, bookSerialProvider, child) {
                                ...
                                return ListView.builder(
                                  itemCount: bookSerialButton.bookSerialList
                                      .length,
                                  itemBuilder: (context, index) {
                                    final bookSerial = bookSerialProvider
                                        .bookSerialList[index];
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Visibility(
                                                  visible: bookSerial.status !="Cancelled" && bookSerial.status != "Serving",
                                                  child: Padding(
                                              ...
                                              children: [
                                                ...
                                                Visibility(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: GestureDetector(
                                                        onTap: () {
                                                          _showCommentDialogBox(context, bookSerial);
                                                        },
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("Book a Serial", style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 18,
                          ...
                          DropdownSearch<Businesstype>(
                            ...
                            onChanged: (newValue) {
                              ...
                              if (newValue.id == 1) {
                                print(
                                    "Fetching organizations for Business Type ID: ${newValue
                                        .id}");
                                  ...
                                  return DropdownSearch<OrganizationModel>(
                                    ...
                                    onChanged: (OrganizationModel? Newvalue) {
                                      dialogSetState(() {
                                        ...
                                        context
                                            .read<
                                            ServiceCenterByTypeProvider>()
                                            .clearData();
                                      });
                                      if (Newvalue != null &&
                                          Newvalue.id != null) {
                                        print(
                                            "✅ Organization Selected. Fetching Service Centers for Company ID: ${Newvalue
                                                .id}");
                          ...
                          Consumer<serviceCenter_serialBookProvider>(
                              builder: (context, orgServiceCenterProvider,
                                  child) {
                                return Consumer<ServiceCenterByTypeProvider>(
                                    builder: (context,
                                        typeServiceCenterProvider, child) {
                                      final List<
                                          ServiceCenterModel> allServiceCenters = [
                                        ...orgServiceCenterProvider
                                            .serviceCenterList,

                                        ...typeServiceCenterProvider
                                            .serviceCenters,

                                      ];
                                      final bool isLoading = orgServiceCenterProvider
                                          .isLoading ||
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    print(
                                        'Selected Business Type: ${_dialogSelectedBusinessType
                                            ?.name}');
                                    print(
                                        'Selected Organization: ${_selectedOrganization
                                            ?.name}');
                                    print(
                                        'Selected Service Center: ${_selectServiceCenter
                                            ?.name}');
                                    print(
                                        'Selected Service Type: ${_selectedServiceType
                                            ?.name}');
                                    ...
                                    if (_dialogFormKey.currentState!
                                      ...
                                      final String? businessTypeId = _dialogSelectedBusinessType?.id?.toString();
                                      final String? organizationId = _selectedOrganization?.id;
                                      final String? serviceCenterId = _selectServiceCenter?.id;
                                      ...
                                      if (_dialogSelectedBusinessType?.id ==
                                          1 && organizationId == null) {
                                        isIdMissing = true;
                                      }
                                      if (isIdMissing) {
                                        ScaffoldMessenger
                                      ...
                                      final String serviceTakerId = authProvider
                                          .userModel!.user.id;
                                      final bool forSelfValue = _SelectUserName ==
                                          UserName.Self;
                                      final String serviceDate = DateController
                                          .text.isNotEmpty ? DateController.text
                                  ...
                                  child: Text(
                                    "Request for serial", style: TextStyle(
                                      color: Colors.white
                                  ),)),
                              SizedBox(width: 10,),
                              ElevatedButton(
...
// Edit Book Serial DialogBox
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("Edit Book a Serial", style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold
                              ),),
                          ...
                          Consumer<serviceTypeSerialbook_Provider>(
                              builder: (context, serviceTypeProvider, child) {
                                if (serviceTypeProvider.isLoading &&
                                    serviceTypeProvider.serviceTypeList
                                        .isEmpty) {
                                  return Center(
                                      child: CircularProgressIndicator(
                                        color: AppColor().primariColor,
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    final String? serviceTypeId = _selectedServiceType
                                        ?.id;
                                    final bool forSelfValue = _SelectUserName ==
                                        UserName.Self;
                                    final String? bookingId = mybook_Serial.id;
                                    final String? serviceCenterId = mybook_Serial
                                        .serviceCenter?.id;
                                    ...
                                    if (_dialogFormKey.currentState!
                                      ...
                                      if (success) {
                                        ...
                                        final String serviceDate = DateController
                                            .text.isNotEmpty ? DateController
                                            .text
                                            : DateFormat('yyyy-MM-dd').format(
                                            DateTime.now());
  ...
  //
  void _showCommentDialogBox(BuildContext context, MybookedModel mybook_Serial){
    ServiceCenterModel? _selectServiceCenter;
    serviceTypeModel ? _selectedServiceType;
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text("Cancel Serial", style: TextStyle(
                            color: Colors.black,
                            fontSize: 18,
                            fontWeight: FontWeight.bold
                        ),),
                    ...
                    SizedBox(height: 20,),
                    Text("Please enter the reason or comment",style: TextStyle(
                      color: Colors.black,
                      fontSize: 15,
                      fontWeight: FontWeight.w500
                    ),),
                    ...
                    TextField(
                      ...
                      maxLines: 5,
                      minLines: 3,cursorColor: Colors.grey.shade300,
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(5),
                    ...
                    Row(
                      ...
                      children: [
                            ...
                            onPressed: ()async {
                              ...
                              if (comment.isEmpty) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Please enter a reason to cancel.')),
                                );
                                return;
                              }
                              ...
                              final success= await Provider.of<CommentCancelButtonProvider>(context,listen: false).commentCancelButton(
                                id: bookingId,
                                serviceCenterId: serviceCenterId,
                                serviceTypeId: serviceTypeId,
                                comment: comment,
                              ...
                              if(success){
                                ...
                                if (!mounted) return;
                                final String serviceDate = DateFormat('yyyy-MM-dd').format(DateTime.now());


                                await Provider.of<GetBookSerialProvider>(context, listen: false)
                                    .fetchgetBookSerial(serviceDate);
                        ...
                        }, child: Text("Cancel Serial",style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold
                        ),
                        )
