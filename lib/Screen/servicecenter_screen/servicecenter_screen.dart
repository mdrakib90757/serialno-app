...
class _ServicecenterScreenState extends State<ServicecenterScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (companyId != null && companyId.isNotEmpty) {
        ...
        debugPrint("❌ ServicecenterScreen: Company ID not found on init. Cannot fetch list.");
      }
    });
  }
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10,),
            getAddButtonProvider.isLoading ? Center(child: CircularProgressIndicator(
