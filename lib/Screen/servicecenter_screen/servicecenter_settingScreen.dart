...
class Servicecenter_Settingscreen extends StatefulWidget {
  ...
  @override
  State<Servicecenter_Settingscreen> createState() => _Servicecenter_SettingscreenState();
}

class _Servicecenter_SettingscreenState extends State<Servicecenter_Settingscreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (companyId != null && companyId.isNotEmpty) {
        ...
        Provider.of<CompanyDetailsProvider>(context, listen: false).fetchDetails(companyId);
        Provider.of<BusinessTypeProvider>(context, listen: false).fetchBusinessTypes();
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    if (companyDetails.companyDetails == null) {
      return Scaffold(body: Center(child: Text("Could not load company info.")));
    }


    final company_man = companyDetails.companyDetails!;
    final String businessTypeName = businessType.getBusinessTypeNameById(company_man.businessTypeId) ?? 'N/A';
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text("${company_man.name}",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                Text("Address Line1 : ",style: TextStyle(
                    color: Colors.grey.shade600
                ),),
                Text("${company_man.addressLine1} ",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${company_man.addressLine2}",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${company_man.email}",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${company_man.phone} ",style: TextStyle(
                    color: Colors.black,
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${companyDetails.companyDetails?.businessType?.name}",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${company_man.division?.name}",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${company_man.district?.name}",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                Text("Thana : ",style: TextStyle(
                    color: Colors.grey.shade600
                ),),
                Text("${company_man.thana?.name} ",style: TextStyle(
                    color: Colors.black
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("${company_man.area}",style: TextStyle(
                    color: Colors.grey.shade600
                ),),
              ],
            ),
